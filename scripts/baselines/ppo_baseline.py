"""PPO baseline using stable-baselines3 on GroceryPricingEnv."""
...
def main() -> None:
    ...
    if args.use_wandb:
        wandb.init(project="dreamprice", group="baselines", name=f"ppo-seed{args.seed}")
    ...
    print(f"PPO avg episode reward: {avg_reward:.2f}")
